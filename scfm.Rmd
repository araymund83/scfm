...
tempStudyArea <- LandR::randomStudyArea(size = 10000 * 6.25* 2500) #hectares * ha/pixel * pixels in landscape
rtm <- LandR::prepInputsLCC(studyArea = tempStudyArea, destinationPath = tempdir(), filename2 = NULL)
tempStudyArea <- spTransform(tempStudyArea, CRSobj = crs(rtm))
#study area and rasterToMatch need same crs
objects <- list(
